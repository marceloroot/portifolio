...
function Start() {
    return (  
      <div id="home" className="flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0 md:justify-around  mt-24 ">
        ...
        <img className="rounded-full border-4 border-solid border-pink-400/[.70]  max-w-[150px] min-w-[100px] md:max-w-[200px]" src="https://github.com/marceloroot.png" alt="avatar" />
      </div>
      </div>
    );
  }
